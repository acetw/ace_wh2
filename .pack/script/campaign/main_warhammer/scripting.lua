...
cm:add_game_created_callback(
	function()	
		...
		local_faction = cm:get_local_faction(true);
		...
		if local_faction then
			...
			if cm:load_faction_script("faction_script_loader") then
				dec_tab();
...
-------------------------------------------------------
--	Advanced Campaign Enhancement
-------------------------------------------------------
package.path = package.path .. ";data/ace_wh2/?.lua";
require("ace_wh2/Init");
